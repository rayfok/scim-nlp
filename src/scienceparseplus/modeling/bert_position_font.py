...
from ..constants import MAX_2D_POSITION_EMBEDDINGS, MAX_FONT_NUMBER
...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.x_position_embeddings = nn.Embedding(
            MAX_2D_POSITION_EMBEDDINGS, config.hidden_size
        )
    ...
    def forward(
        self, input_ids=None, token_type_ids=None, position_ids=None, bbox=None, font_ids=None, inputs_embeds=None, past_key_values_length=0
    ):
